.data
list: .long 10, 20, 30, 40, 50, 60, 700, 80, 90, 100
length: .byte 10
long_size: .byte 4
str: .asciz "El maximo es: %d\n"
...
.global main
main:
    # inicializamos el registro eax con el valor de la primera posicion de list.
    movl (list), %eax
    # inicializamos el registro rcx con la longitud del arreglo. (ya que queremos que itere por todos los elementos del arreglo).
    xorq %rcx, %rcx
    movb length, %cl
    cuerpo_for:
